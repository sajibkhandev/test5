...
import Trendimg from "../assets/trending.png"
    ...
    <Container>
        <div className=" lg:flex justify-between ">
           <div className="lg:w-[50%] w-full">
            <img className='' src={Trendimg} alt="" />
           </div>
           <div className="lg:w-[50%] w-full">
            ...
            <div className=" relative mt-[40px] after:absolute after:contain-[''] after:top-[2px] after:left-0 after:h-[15px] after:w-[15px] after:bg-[#FB2E86] after:rounded-full">
                <h4 className='font-Sans font-bold text-[16px] text-[#1A0B5B4D] ml-[20px] items-center '>All frames constructed with hardwood solids and laminates</h4>
            </div>
            <div className=" relative mt-[40px] after:absolute after:contain-[''] after:top-[2px] after:left-0 after:h-[15px] after:w-[15px] after:bg-[#0D0E43] after:rounded-full">
                <h4 className='font-Sans font-bold text-[16px] text-[#1A0B5B4D] ml-[20px] items-center '>Reinforced with double wood dowels, glue, screw - nails corner 
            ...
            <div className=" relative mt-[40px] after:absolute after:contain-[''] after:top-[2px] after:left-0 after:h-[15px] after:w-[15px] after:bg-[#05E6B7] after:rounded-full">
                <h4 className='font-Sans font-bold text-[16px] text-[#1A0B5B4D] ml-[20px] items-center '>Arms, backs and seats are structurally reinforced</h4>
            </div>
            <div className="flex mt-[50px] gap-6">
                ...
                <h3 className='font-Sans font-semibold text-[14px] text-[#151875]  '>$32.00</h3>
                </div>
            </div>
           </div>
        </div>
