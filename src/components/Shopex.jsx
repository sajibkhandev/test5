        ...
        <div className=" text-center ">
            ...
            <div className="lg:w-[24%] w-full pt-[20px] pb-2 bg-[#fff] ">
                   ...
                   <div className=" relative text-center  w-[100%] px-[40px] bg-[#fff] mt-[20px]  ">
                        ...
                        <h4 className=' relative font-Sans font-bold text-[16px] text-[#1A0B5B4D] mt-[10px] '>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Massa purus gravida.</h4>
